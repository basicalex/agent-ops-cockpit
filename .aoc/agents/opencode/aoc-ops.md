...
- Ensuring tag-level default PRDs plus task-level override links (`aocPrd`) and `.taskmaster/docs/prds/` usage are documented and consistent.
...
- Never add PRD links to subtasks; use tag-level defaults with task-level overrides.
