//! Mind summary and observer-section host render helpers.
//!
//! These helpers keep Mission Control-specific screen composition formatting out
//! of `mind_glue`, while still using Mission Control theme choices and layout.

use super::*;

pub(crate) fn render_mind_summary_lines(
    app: &App,
    artifact_snapshot: &MindArtifactDrilldown,
    detached_jobs: &[InsightDetachedJob],
    theme: MissionTheme,
    compact: bool,
) -> Vec<Line<'static>> {
...
pub(crate) fn render_mind_observer_lines(
