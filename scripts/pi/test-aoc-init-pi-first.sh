...
ln -s "$repo_root/bin/aoc-voxtype-setup" "$fake_bin/aoc-voxtype-setup"
...
voxtype_filter="$HOME/.local/bin/voxtype-aoc-lexicon-filter"
voxtype_system_lexicon="$XDG_CONFIG_HOME/aoc/voxtype-lexicon.md"
...
assert_exists "$voxtype_filter"
assert_exists "$voxtype_system_lexicon"
assert_exists "$voxtype_config"
assert_contains 'command = "'"$voxtype_filter"'"' "$voxtype_config"
assert_contains '### VoxType' "$voxtype_system_lexicon"
